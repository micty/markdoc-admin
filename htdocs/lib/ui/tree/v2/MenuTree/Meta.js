...
* 
*/
define('MenuTree.v2/Meta', function (require, module, exports) {
    ...
    return {
        ...
        create: function (config, others) {
            ...
            var meta = {
                ...
                */
                'init': function (item) {
                    var id = item.id;   //用于数据节点的 id。
                    var eid = '';       //用于 DOM 元素的 id。
                    var list = item.list = item.list || [];  //不管有没有子节点，为处理方便，这里统一分配一个数组。
